...
& $compilerPath /nologo /target:exe "/out:$testExePath" (Join-Path $projectRoot 'Assets/TradeWinds/Core/ShipSimulation.cs') (Join-Path $projectRoot 'Tests/ShipSimulationTests.cs')
